"""
Basic tests for the Disheap Python SDK.
...
class TestMessage:
    ...
    def test_message_lease_expiry(self):
        ...
        # Should not be expiring soon with default threshold
        assert not message.is_lease_expiring_soon
...
class TestIntegration:
    ...
    async def test_basic_workflow(self):
        ...
        # This would normally connect to a real engine,
        # but our mock implementation allows basic testing
